              ...
              <FadeIn direction="left">
                ...
                <a
                  ...
                  style={{
                    ...
                    marginTop: '2rem', padding: '20px 24px', borderRadius: '14px',
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    <div style={{
                      ...
                      <svg viewBox="0 0 24 24" width="26" height="26" fill="#ff5000" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                      <p style={{ color: '#fff', fontWeight: 700, fontSize: '1rem', margin: 0 }}>WhatsApp</p>
                      <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.875rem', margin: '2px 0' }}>Start a conversation with us</p>
                      <p style={{ color: '#ff5000', fontSize: '0.8rem', margin: 0 }}>We typically reply within minutes</p>
                    </div>
                  </div>
                  <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
                      <div style={{
                        width: 40, height: 40, borderRadius: '50%', border: '2px solid #ff5000',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                      }}>
                        <ArrowRight size={18} color="#ff5000" style={{ transform: 'rotate(-45deg)' }} />
                      </div>
                      <span style={{ color: '#fff', fontSize: '0.8rem', fontWeight: 600 }}>Chat Now</span>
                    </div>
                  </div>
                </a>
              </FadeIn>

...
function ContactForm() {
  ...
  return (
    <div style={{
      ...
      <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#fff', marginBottom: '1.25rem' }}>Connect With Us</h3>
      ...
      {status === 'success' ? (
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
          ...
          <button
            ...
            style={{
              height: '44px', borderRadius: '8px', border: 'none', cursor: 'pointer',
              ...
              <FadeIn direction="left">
                ...
                <div className="space-y-6">
                  {[
                    ...
                    { icon: Mail, label: "Email", value: "admin@blackgalaxy.co.in", href: "mailto:admin@blackgalaxy.co.in" },
                    { icon: Phone, label: "Phone", value: "+91 72042 57430" },
                ...
                {/* WhatsApp Banner */}
                <a
                  href="https://wa.me/917204257430"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                    marginTop: '1.25rem', padding: '12px 16px', borderRadius: '12px',
                    background: 'rgba(20,20,30,0.8)', border: '1px solid rgba(255,255,255,0.08)',
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{
                      ...
                      border: '2px solid #ff5000', display: 'flex', alignItems: 'center', justifyContent: 'center',
                    }}>
                      <svg viewBox="0 0 24 24" width="20" height="20" fill="#ff5000" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                      <p style={{ color: '#fff', fontWeight: 700, fontSize: '0.875rem', margin: 0 }}>WhatsApp</p>
                      <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.75rem', margin: '1px 0' }}>Start a conversation with us</p>
                      <p style={{ color: '#ff5000', fontSize: '0.7rem', margin: 0 }}>We typically reply within minutes</p>
                    </div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexShrink: 0 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                      <div style={{
                        width: 32, height: 32, borderRadius: '50%', border: '2px solid #ff5000',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                      }}>
                        <ArrowRight size={14} color="#ff5000" style={{ transform: 'rotate(-45deg)' }} />
                      </div>
                      <span style={{ color: '#fff', fontSize: '0.7rem', fontWeight: 600 }}>Chat Now</span>
                    </div>
                  </div>
                </a>
              </FadeIn>
